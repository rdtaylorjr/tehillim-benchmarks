...
def test_load_psalm_vectors_pools_a_dense_file(tmp_path: Path) -> None:
    ...
    centroids = load_psalm_vectors(path, COLA)
...
def test_load_psalm_vectors_pools_a_sparse_file_to_the_same_centroids(tmp_path: Path) -> None:
    ...
    from_dense = load_psalm_vectors(dense, COLA)
    from_sparse = load_psalm_vectors(sparse, COLA)
...
def test_load_psalm_vectors_skips_a_psalm_missing_one_of_its_cola(tmp_path: Path) -> None:
