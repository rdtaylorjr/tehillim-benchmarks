...
def test_build_unmarked_bicola_pairs_adjacent_unmarked_nodes() -> None:
    ...
    pairs = build_unmarked_bicola(half_verses_by_psalm, marked_nodes=set())
...
def test_build_unmarked_bicola_excludes_a_pair_touching_a_marked_node() -> None:
    ...
    pairs = build_unmarked_bicola(half_verses_by_psalm, marked_nodes={11})
...
def test_build_unmarked_bicola_handles_a_single_half_verse_psalm() -> None:
